  ...
  return (
    <section className="glass-panel relative overflow-hidden rounded-[2rem] border border-white/70 bg-white/80 p-6 shadow-[0_30px_70px_-36px_rgba(15,23,42,0.38)] sm:p-8">
      ...
      <div className="relative mt-6 grid gap-4 sm:grid-cols-2">
        <div className="float-slow rounded-[1.5rem] border border-slate-200/80 bg-gradient-to-br from-white to-slate-50 p-5 shadow-[0_20px_45px_-30px_rgba(15,23,42,0.4)] transition duration-300 hover:-translate-y-1">
        ...
        <div className="float-delayed rounded-[1.5rem] border border-slate-200/80 bg-gradient-to-br from-white to-slate-50 p-5 shadow-[0_20px_45px_-30px_rgba(15,23,42,0.4)] transition duration-300 hover:-translate-y-1">
      ...
      <div className="relative mt-5 rounded-[1.5rem] border border-slate-200/80 bg-slate-50/85 p-5 shadow-sm">
        ...
        {categoryBreakdown.length === 0 ? (
          <div className="mt-5 rounded-2xl border border-dashed border-slate-200 bg-white/80 px-6 py-10 text-center">
